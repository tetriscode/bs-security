...
/**
 * Access Token Converter for Oracle token details.
 *
 * @author Alessio Fabiani, GeoSolutions S.A.S.
 */
public class OracleAccessTokenConverter extends DefaultAccessTokenConverter {

    private UserAuthenticationConverter userTokenConverter;

    public OracleAccessTokenConverter() {
        final DefaultUserAuthenticationConverter defaultUserAuthConverter =
                new OracleUserAuthenticationConverter("email");
